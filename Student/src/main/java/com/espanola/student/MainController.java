...
import java.util.Optional;
    ...
    @Controller
    @RequestMapping(path="/espanola/student") // Updated URI
    public class MainController {
        ...
        public ResponseEntity createStudent(@RequestBody Student student) throws URISyntaxException {
            ...
            return ResponseEntity.created(new URI("/espanola/student/" + savedStudent.getId())).body(savedStudent);
        }
